  ...
  const useCases = [
    {
      ...
      description: "Let visitors connect, without complex passwords or vouchers. Earn per minute."
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Get rewarded just by leaving your router on. Make your internet work for you."
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Access verified hotspots globally. Replace expensive roaming plans."
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Build local mesh networks and decentralized digital infrastructure."
    }
  ];

  return (
    <section id="use-cases" className="relative py-20 bg-gradient-to-b from-gray-900 to-black">
      {/* Background Effects */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Where EtherSpot Works?
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Discover the diverse applications and environments where EtherSpot transforms connectivity
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-primary/20 to-secondary/20 rounded-xl p-8 border border-primary/30">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Join thousands of users already earning from their WiFi connections. 
              Start your journey with EtherSpot today.
            </p>
