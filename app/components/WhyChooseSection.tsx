  ...
  const features = [
    {
      ...
      description: "No central provider. You control access, pricing, and uptime."
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Why Choose EtherSpot?
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Experience the future of decentralized connectivity with unmatched benefits
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <div className="text-center space-y-2">
              ...
              <div className="text-gray-300">Encrypted Connection</div>
            </div>
          </div>
        </div>
      </div>
